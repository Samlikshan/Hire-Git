...
exports.ListJobHistoryUseCase = void 0;
class ListJobHistoryUseCase {
    ...
    execute(candidateId) {
        return __awaiter(this, void 0, void 0, function* () {
            const jobHistory = yield this.InterviewRepository.ListJobHistory(candidateId);
            //temp
...
exports.ListJobHistoryUseCase = ListJobHistoryUseCase;
